...
/// <summary>Light palette for the SuperAdmin panel — the rest of the app (including the audience-facing
/// Namoyish Ekrani) stays on the dark <see cref="AppColors"/> palette per the project's design spec; this is
/// scoped to that one screen rather than a global theme swap.</summary>
